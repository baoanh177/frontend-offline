        ...
        <>
            ...
            >
                ...
                <div className="mt-4 flex justify-around">
                    <div className="flex gap-1 [&>*]:cursor-pointer cursor-pointer">
                        <input
                            type="radio"
                            name="status"
                            id="private"
                ...
                <button 
                    form="share_form"
                    type="submit"
                    className={clsx('flex items-center gap-1 justify-center rounded-md w-full py-1 text-lg mt-4',
                    loading ? "bg-green-800 text-gray-300" : "bg-green-600 text-white")}
                    onClick={handleClick}
                >
                    {loading ?
                    <>
                        <div role="status">
                            <svg aria-hidden="true" className="w-5 h-5 text-gray-200 animate-spin fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
